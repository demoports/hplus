...
(function (root) {
  ...
  HP.fn_1d2bd = function (ebp, esi, edi) {
    for (let c = 0x55; c > 0; c--) {
      let eax = (HP.fn_2c2c8(0x190) - 0x1770) | 0; wr32(0x1bcd8, eax); wrf(edi + 0xc, eax);
      eax = (HP.fn_2c2c8(0x28) + ebp) | 0; wr32(0x1bcd8, eax); wrf(edi + 4, eax);
      eax = (HP.fn_2c2c8(0x28) + esi) | 0; wr32(0x1bcd8, eax); wrf(edi + 8, eax);
      wr32(0x1bcd8, -0x1e); wrf(edi + 0x20, -30);
      edi += 0x2c;
    }
    return edi;
  };
  ...
  HP.fn_1d39f = function () {
    let eax = HP.fn_29a(0xb73dc); eax = ((eax | 0xffff) + 1) >>> 0;
    wr32(0x1bcbc, eax); eax += 0x4b000; wr32(0x1bcc8, eax); eax += 0x4b000; wr32(0x1bcc0, eax);
    eax += 0x13dc; wr32(0x1bcc4, eax); eax += 0x10000;
    HP.fill32(rd32(0x1bcbc), 0, 0x96000);        // (overruns the allocation, as the original does)
    wr32(0x1bd04, 1); wr32(0x1bd08, 0x18); wr32(0x1bd09, 0x18); wr32(0x1bd0a, 0x25);
    HP.fn_2432c(0x1bc80, 0x1bcdc);                // (edx, ebp)
    HP.fn_2a094(0xff, 0x1bcdc);                   // (ecx, ebp)
    HP.fn_2a094(0x7d0, 0x1c1f4);
    let ebp = rd32(0x1c708);
    for (let edx = 0x7d0; edx > 0; edx--) {
      eax = (HP.fn_2c2c8(0x320) - 0x190) | 0; wr32(0x1cb40, eax); wrf(ebp + 4, eax);
      eax = (HP.fn_2c2c8(0x320) - 0x190) | 0; wr32(0x1cb40, eax); wrf(ebp + 8, eax);
      eax = (HP.fn_2c2c8(0x1770) - 0xbb8) | 0; wr32(0x1cb40, eax); wrf(ebp + 0xc, eax);
      wr32(0x1cb40, -0x3c); wrf(ebp + 0x20, -60);
      ebp += 0x2c;
    }
    HP.fn_28ed8(1, 0x1bcdc); HP.fn_28ed8(1, 0x1c1f4);   // (eax, ebp)
    wr32(0x1bcd8, 0x29); wrf(0x1c1f8, 41); wrf(0x1c208, 41);
    wr32(0x1bcd8, 0x1f); wrf(0x1c1fc, 31); wrf(0x1c210, 31);
    eax = HP.fn_29a(0x3ba4); eax = (eax | 0xf) + 1; wr32(0x1ca6c, eax);
  ...
  function zoomCopy(dst, src, step, blend) {
    ...
    do {
      ...
      wr32(0x1bcd8, rds32(0x1bcd8) - 1);
    } while (rds32(0x1bcd8) !== 0);
  }
  ...
  HP.fn_1dab0 = function () {
    ...
    HP.fn_2b037(0x1c770, rd32(0x1bcd0));          // (ebx=angles, ecx=matrix)
    ...
    if (rds32(esi + 0x30) === 0x14 && rds32(esi + 0x34) === 0x3a) {
      if (rds32(0x1bc94) !== 1) {
        wr32(0x1bc94, 1);
        wr32(0x1bc90, rds32(0x1bc90) - 0x40);
        if (rds32(0x1bc90) <= 0) wr32(0x1bc90, 0);
        wr32(0x1bca4, rds32(0x1bca4) - 0x2ee0);
        if (rds32(0x1bca4) <= 0x64) wr32(0x1bca4, 0x64);
      }
    } else wr32(0x1bc94, 0);
    if (rds32(0x1bc9c) === 1) {
      wr32(0x1bca0, rds32(0x1bca0) - 0x3e8);
      if (rds32(0x1bca0) <= 0x3e8) wr32(0x1bca0, 0x3e8);
    }
    if (rds32(0x1bc9c) === 2) {
      wr32(0x1bca0, rds32(0x1bca0) + 0x3e8);
      if (rds32(0x1bca0) >= 0x10000) wr32(0x1bca0, 0x10000);
    }
  ...
  HP.fxD_init = function (eax) {
    ...
    wr32(0x2ee54, 0);
    wr32(0x1bc9c, 0); wr32(0x1bca0, 0x10000);
    HP.fill32(rd32(0x1bcbc), rd32(rd32(0x1c140)), 0x12c00);
  };
  HP.fxD_render = function () {
    const M = HP.M;
    const path = rd32((rd32(0x1c7b8) & 3) * 4 + 0x1c7e0);
    wr32(0x28c9c, 1);
    HP.fn_2afd3(0x1c770, 0x1c70c, path, 0x1bcdc);     // (ebx, esi, edi, ebp)
    const s44 = rd32(0x1bd44), s3c = rd32(0x1bd3c);
    wr32(0x1bd44, 0); wr32(0x1bd3c, 0);
    HP.fn_2a2ac(0x1c70c, 0x1bcdc, rd32(0x1bcbc));      // (esi, ebp, edi) — engine signature order
    wr32(0x1bd3c, s3c); wr32(0x1bd44, s44);
    HP.fn_1cd19(0x1c70c, 0x1bcdc);
    wr32(0x1bcd8, 8); wrf(0x1c228, rdf(0x1bd10) / 8);
    HP.fill32(rd32(0x1bcc0), 0, 0x4f7);
    HP.fn_2a2ac(0x1c70c, 0x1c1f4, rd32(0x1bcc0));
    {
    ...
    HP.fn_1d09f(rd32(0x1c140), rd32(0x1c13c), rd32(0x1ca6c), rd32(0x1bcbc));   // (eax, ebp, esi, edi)
    HP.fn_2a2ac(0x1c70c, 0x1bcdc, rd32(0x1bcbc));
    wr16(0xbc, rd16(0x1ca68));
    let esi = rd32(0xe20);
    if (rds32(esi + 0x30) === 0x13 && rds32(esi + 0x34) >= 0x24) {
      wr32(0x1bc9c, 1);
      if (rds32(esi + 0x34) >= 0x28) wr32(0x1bc9c, 2);
      if (rds32(0x1bca0) !== 0x10000) {
        const e = (0x10000 - rds32(0x1bca0)) | 0;
        wr32(0x1bcac, Math.imul(e, 0x78)); wr32(0x1bca8, Math.imul(e, 0xa0));
        zoomCopy(rd32(0x1bcbc), rd32(0x1bcc8), rds32(0x1bca0), true);
      }
    }
    esi = rd32(0xe20);
    if (rds32(esi + 0x30) === 0x14 && rds32(esi + 0x34) >= 0x34 && rds32(esi + 0x34) <= 0x38) {
      ...
      HP.fn_18135(rd32(0x1c790), rd32(0x1c78c), rd32(0x1bcbc));   // (ecx, edx, edi)
    }
    if (rds32(0x1bca4) !== 0x10000) {
      const e = (0x10000 - rds32(0x1bca4)) | 0;
      wr32(0x1bcac, Math.imul(e, 0x78)); wr32(0x1bca8, Math.imul(e, 0xa0));
      zoomCopy(rd32(0x1bcc8), rd32(0x1bcbc), rds32(0x1bca4), false);
      const t = rd32(0x1bcbc); wr32(0x1bcbc, rd32(0x1bcc8)); wr32(0x1bcc8, t);
    }
    if (rds32(0x1bc90) !== 0x400) HP.fn_1574e(rds32(0x1bc90), rd32(0x1bcbc));
    esi = rd32(0xe20);
    if (rds32(0x1bc98) !== 1 && rds32(esi + 0x30) === 0x14 && rds32(esi + 0x34) === 0x1c) { wr32(0x1bc90, 0x200); wr32(0x1bc98, 1); }
    else { wr32(0x1bc90, 0x400); wr32(0x1bc98, 0); }
  };
  ...
  HP.fxD_post = function () {
    ...
    if (rds32(0x1bca4) === 0x10000) { const t = rd32(0x1bcbc); wr32(0x1bcbc, rd32(0x1bcc8)); wr32(0x1bcc8, t); }
    HP.fill32(rd32(0x1bcbc), rd32(rd32(0x1c140)), 0x12c00);
    if (HP.fn_2c2c8(5) === 3) {
      wr32(0x1bccc, 1);
      let ebp = HP.fn_2c2c8(0xffffffff);
      HP.fn_2c2c8(0xffffffff);                      // result discarded by the original (clobbered)
      let eax = HP.fn_2c2c8(7);
    ...
    } else if (rds32(0x1bccc) === 1) {
      HP.copy(rd32(0x1c13c), rd32(0x1bcc4), 0x4000 * 4);
    }
    if (rd8(0x9c9) === 1) { wr32(0x1084, 1); return true; }
    const esi = rd32(0xe20);
  ...
  HP.fn_1d566 = function* (eax) {
    ...
    for (;;) {
      HP.fxD_render();
      HP.fn_2b0a8(rd32(0x1bcbc), 0x1bcdc);               // present (esi=buffer, ebp=obj)
      yield;

...
//   HP.fn_29a(eax=size)                      core: high-memory bump allocator
//   HP.fn_2c2c8(eax=range)                   core: RNG
//   HP.fn_156ff(esi=chunk, edi=dst) -> edi   part A: copy length-prefixed chunk + 0 terminator
//   HP.fn_1570b(esi=&k, ebp=&cam)            part A: camera smoothing (6 floats)
//   HP.fn_18135(ecx, edx, edi=buffer)        part B: blend/fade of a 320x240x32 buffer (ecx/edx = 255-x / x weights)
//   HP.fn_29060(eax, ebx, ecx, edx=-1, esi, edi=chunk data, ebp=object)   engine: build object from chunk data (ecx unused)
//   HP.fn_2a094(ecx, ebp=object)             engine: object init
//   HP.fn_28ed8(eax=1, ebp=object)           engine
//   HP.fn_2afd3(ebx=&angles, esi=&cam, edi=path, ebp=object)   engine: camera/path step
//   HP.fn_2a2ac(esi=&cam, ebp=object, edi=dest buffer)         engine: render object (note: engine's arg order)
//   HP.fn_2af3a()                            engine (called at the start of each update step)
//   HP.fn_2b037(ebx=&angles, ecx=matrix)     engine: rotation matrix from angles
//   HP.fn_2b0a8(esi=buffer, ebp=object)      engine: present
...
HP.fn_1f87e = function (esi, edi, ebp) {
  for (let c = 0x40; c > 0; c--) {
    let eax = (HP.fn_2c2c8(0x190) - 0xc8) | 0;
    wr32(0x1ef34, eax); wrf(edi + 8, eax);
    eax = ((HP.fn_2c2c8(0x28) + ebp) | 0) >> 4;
    wr32(0x1ef34, eax); wrf(edi + 4, eax);
    eax = ((HP.fn_2c2c8(0x28) + esi) | 0) >> 4;
...
HP.fn_1fd0c = function () {
  ...
  wr32(0x1fab4, 0x12c);
  do {
    wr32(0x1f99c, (HP.fn_2c2c8(0x280000) + rd32(0x1fab0)) | 0);
    wr32(0x1f9a0, (HP.fn_2c2c8(0xa0000) + 0x820000) | 0);
    let eax = (HP.fn_2c2c8(0x2710) + rds32(0x1fac8)) | 0;
    if (eax === 0) eax = 1;
    wr32(0x1f9a4, eax);
    HP.fn_1f9b0();
...
HP.fn_1fde5 = function () {
  ...
  wr32(0x1ef24, eax); eax += 0x4b000; wr32(0x1ef28, eax); eax += 0x4b000;
  wr32(0x23fd0, 0);
  HP.fn_156ff(0x1dcb4, rd32(0x1ef24));
  HP.fn_29060(0, 1, 0, 0xffffffff, rd32(0x1ef2c), rd32(0x1ef24), 0x1ef38);  // (eax, ebx, ecx(unused), edx, esi, edi, ebp)
  HP.fn_156ff(0x1eb1b, rd32(0x1ef24));
  HP.fn_29060(3, 9, 0, 0xffffffff, rd32(0x1ef2c), rd32(0x1ef24), 0x1ef38);
  wr32(0x1efa4, 1); wr32(0x1ef60, 0);
  wr32(0x1ef64, 0x1a); wr32(0x1ef65, 0x1a); wr32(0x1ef66, 0x28);   // overlapping dword stores, keep order
  HP.fill32(rd32(0x1ef24), 0, 0x25800);
  HP.fn_2a094(0xc0, 0x1ef38);          // (ecx, ebp)
...
HP.fn_1fde5_tail = function () {      // 0x1feda .. 0x1ffe4
  ...
  const ecx = eax;
  eax = HP.fn_29a(eax + 0x10); eax = (eax | 0xf) + 1;
  wr32(0x1f8f4, eax);
  ...
  HP.fn_1fa8a();
  wr32(0x28e38, 0x1010102); wr32(0x28e3c, 0x9192919);      // RNG reseed
...
HP.fn_20240 = function () {
  ...
  HP.fn_2af3a();
  HP.fn_2b037(0x1f4b4, rd32(0x1ef2c));          // (ebx=angles, ecx=matrix)
  HP.fn_20262();
};
HP.fn_20262 = function () {                       // pure tail of the update step
  ...
  if (rds32(0x1f51c) !== 3) {
    ...
    if (eax !== rd32(0x1f520)) {
      wr32(0x1f520, eax);
      wr32(0x1f51c, (rd32(0x1f51c) + 1) & 3);
      const ebx = rd32(0x1f51c);
      if (rd32(ebx * 4 + 0x1f544) !== rd32(ebx * 4 + 0x1f540)) {
        const s = rd32(0x1f51c);
  ...
  wr32(0x1f778, 0);
  if (rds32(0x1f51c) === 1) {
    const esi = rd32(0xe20), row = rds32(esi + 0x34);
    if (row >= 4 && row <= 0xc) { wr32(0x1f774, 2); wr32(0x1f778, 1); }
  }
  if (rds32(0x1f51c) === 2) {
    const esi = rd32(0xe20), row = rds32(esi + 0x34);
    if (row >= 4 && row <= 0xc) { wr32(0x1f774, 1); wr32(0x1f778, 1); }
  }
  let eax = rd32(0x1f4c8), ebx = rd32(0x1f4cc);
  if (rds32(0x1f778) === 1) { eax = rd32(0x1f4d0); ebx = rd32(0x1f4d4); }
  ...
  const esi = rd32(0xe20), order = rds32(esi + 0x30);
...
HP.fn_1ffe5 = function* (eax, ebx) {
  ...
  wr32(0x2ee54, 0);
  HP.fill32(rd32(0x1ef24), rd32(rd32(0x1f39c)), 0x12c00);
  wrf(0x1f4e4, 0);
  for (;;) {
    let edi = rd32((rd32(0x1f51c)) * 4 + 0x1f544);
    wr32(0x28c9c, 1);
    if (rds32(0x1f51c) === 1) wr32(0x28c9c, 0);
    HP.fn_2afd3(0x1f4b4, 0x1f450, edi, 0x1ef38);         // (ebx, esi, edi, ebp)
    HP.fn_1570b(0x1f4e4, 0x1f450);                        // (esi, ebp)
    if (rds32(0x1f51c) === 3) wr32(0x1ef6c, rd32(0x1f4c4));
    ...
    HP.fn_2a2ac(0x1f450, 0x1ef38, rd32(0x1ef24));         // engine signature: (esi=camera, ebp=scene, edi=dest)
    if (rds32(0x1f778) === 1) HP.fn_1fd0c();
    esi = rd32(0xe20);
    ...
    if (order !== 0x18 && (row < 4 || row >= 0x32)) {
      ...
      HP.fn_18135(rd32(0x1f4f4), rd32(0x1f4f0), rd32(0x1ef24));   // (ecx, edx, edi)
    } else {
      wrf(0x1f500, 0);
    }
    HP.fn_2b0a8(rd32(0x1ef24), 0x1ef38);                  // present (esi=buffer, ebp=object)
    yield;
    wr32(0x1ef20, 2);
    let n = Math.trunc((rds32(0x28e28) + 1) / 0xe);
    for (; n > 0; n--) HP.fn_20240();
    const a = rd32(0x1ef24); wr32(0x1ef24, rd32(0x1ef28)); wr32(0x1ef28, a);
    HP.fill32(rd32(0x1ef24), 0, 0x12c00);
